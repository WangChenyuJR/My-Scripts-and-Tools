...
namespace DataSet.Format.generate
{
        public class ViMo_Annotation
        {
                ...
                public static void Gen_SegAnno_ViMo_JSON(RootObject rootObject)
                {
                        // 序列化为JSON
                ...
                public static void Gain_SegAnno_ViMo_JSON(out RootObject rootObject)
                {
                        // 读取JSON文件
                        ...
                        // 反序列化JSON为对象
                        rootObject = JsonConvert.DeserializeObject<RootObject>(jsonContent);
                }
                /// <summary>
